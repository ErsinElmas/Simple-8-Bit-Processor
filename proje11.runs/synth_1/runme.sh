...
HD_PWD='C:/Users/emrek/proje11/proje11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instruction_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instruction_memory.tcl
