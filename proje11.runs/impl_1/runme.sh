...
HD_PWD='C:/Users/emrek/proje11/proje11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instruction_memory.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instruction_memory.tcl -notrace
